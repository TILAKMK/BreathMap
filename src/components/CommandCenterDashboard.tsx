...
export function CommandCenterDashboard() {
  const { aqi, weather, location, locationName, loading, lastUpdate } = useEnvironmentalData();
  ...
  return (
    <main className="relative w-full bg-[#020408] overflow-x-hidden selection:bg-cyan-500/30 font-sans scroll-smooth">
      ...
      <div className="pt-14">
        ...
        <section id="atmospheric-resonance" className="relative w-full px-8 lg:px-20 bg-[#020408] border-y border-white/10" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
          <AtmosphericResonanceSection aqi={aqi} />
        </section>

        {/* SECTION C: ANALYTICS GRID */}
        <section id="analytics-grid" className="relative w-full px-8 lg:px-20 bg-[#070d14]" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
          <AnalyticsGridSection aqi={aqi} />
        </section>

        {/* SECTION D: POLLUTANT BREAKDOWN */}
        <section id="pollutant-breakdown" className="relative w-full px-8 lg:px-20 bg-[#020408] border-y border-white/10" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
          <PollutantBreakdownSection aqi={aqi} />
        </section>

        {/* SECTION E: AI FORECAST + HEALTH ADVISORY */}
        <section id="ai-forecast" className="relative w-full px-8 lg:px-20 bg-[#070d14]" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
